...
public class AlertConfigurationServiceTest {
    ...
    public void testGetAlertConfiguration() {
        // Arrange
        EnumMap<AlertConfigurationFilter, String> criteria = new EnumMap<>(
        ...
        // Act
        GetAlertConfigurationResponse response = alertConfigurationService.getAlertConfiguration(
            criteria);
    ...
    public void testConfigureAlert() {
        ...
        AlertConfigurationEntity entity = new AlertConfigurationEntity("123456", 123456789L, null,
            "METHANE");
